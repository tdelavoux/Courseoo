    ...
    <div class="row jumbotron account-jumbo">
        <div class="account-header">
            ...
            <div class="account-img">
                <div class="rounded-circle profile-img" style="background-image:url('./images/user/<?php echo $userInfos['image'] ? $userInfos['image'] : 'anonyme.jpg';?>');background-position: center;background-repeat: no-repeat;background-size: cover;"></div>
            </div>
        </div>
    </div>
